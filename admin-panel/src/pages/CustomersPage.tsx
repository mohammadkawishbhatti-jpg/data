...
import { Users, Plus, RefreshCw, Send, Trash2, Eye, Copy, KeyRound } from "lucide-react";
...
export default function CustomersPage() {
  ...
  const handleResetPassword = async (e: any) => {
    ...
    try {
      ...
      setNewPassword("");
      setTimeout(() => { setShowResetPw(false); setResetSuccess(""); }, 1500);
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              {loading ? (
                ...
                <tr key={c.id} className="hover:bg-muted/5 cursor-pointer" onClick={() => setViewCustomer(c)}>
