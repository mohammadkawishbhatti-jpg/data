    ...
    <>
      ...
      <section className="py-24 bg-[#0d1f3c] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Link href="/get-quote" className="inline-flex items-center gap-3 bg-[#e63329] hover:bg-red-700 text-white font-black text-lg px-10 py-5 rounded-xl transition-all hover:scale-105 shadow-[0_0_40px_rgba(230,51,41,0.3)]">
