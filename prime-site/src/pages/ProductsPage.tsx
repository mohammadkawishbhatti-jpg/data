...
const FEATURED_CATS = [
  { label: "Mailer Boxes",     slug: "mailer-boxes",      img: "/api/uploads/corrugated-mailer-boxes.webp" },
  { label: "Rigid Boxes",      slug: "rigid-boxes",        img: "/api/uploads/printed-magnetic-closure-boxes-bulk.webp" },
  { label: "Kraft Boxes",      slug: "custom-kraft-boxes", img: "/api/uploads/custom-kraft-boxes-wholesale.webp" },
  { label: "Cake Boxes",       slug: "custom-cake-boxes",  img: "/api/uploads/custom-cake-boxes.webp" },
  { label: "Chocolate Boxes",  slug: "luxury-chocolate-boxes", img: "/api/uploads/luxury-chocolate-boxes.webp" },
  { label: "Cosmetic Boxes",   slug: "cosmetic-boxes",     img: "/api/uploads/custom-cosmetic-boxes.webp" },
];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        minHeight={320}
        ctas={[
          { label: "Get a Free Quote", href: "/get-quote", variant: "primary" },
          ...
          <div className="rounded-3xl bg-gradient-to-r from-[#1a2f5a] to-[#0d1f3c] p-10 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col gap-3 shrink-0">
                <Link href="/get-quote" className="inline-flex items-center justify-center gap-2 bg-[#e63329] hover:bg-[#c42a21] text-white px-7 py-3.5 rounded-xl font-bold text-sm transition-all shadow-lg">
