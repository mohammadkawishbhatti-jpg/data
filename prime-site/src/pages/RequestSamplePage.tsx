...
import {
  ...
  FileCheck, Scissors, PenTool, Layers, Check
} from "lucide-react";
...
export default function RequestSamplePage() {
  ...
  const [form, setForm] = useState({ name: "", company: "", email: "", phone: "", address: "", boxType: "" });
    ...
    <>
              ...
              <form onSubmit={handleSubmit} className="p-8 md:p-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input required type="text" className="w-full p-3 rounded-xl border border-gray-300 focus:border-[#e63329] focus:ring-1 focus:ring-[#e63329] outline-none transition" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="tel" className="w-full p-3 rounded-xl border border-gray-300 focus:border-[#e63329] focus:ring-1 focus:ring-[#e63329] outline-none transition" />
                  </div>
                </div>
                
                <div className="mb-6">
                  <label className="block text-sm font-bold text-[#0d1f3c] mb-2">Primary Interest</label>
                  <select className="w-full p-3 rounded-xl border border-gray-300 focus:border-[#e63329] focus:ring-1 focus:ring-[#e63329] outline-none transition bg-white">
                ...
                <div className="mb-8">
                  ...
                  <textarea required rows={3} placeholder="Street, City, State, ZIP" className="w-full p-3 rounded-xl border border-gray-300 focus:border-[#e63329] focus:ring-1 focus:ring-[#e63329] outline-none transition resize-none"></textarea>
                </div>

                <button type="submit" className="w-full bg-[#e63329] hover:bg-red-700 text-white font-black text-lg py-4 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2">
                  <Package className="w-6 h-6" /> Get My Free Sample Kit
                </button>
      ...
      <section className="py-24 bg-[#0d1f3c]">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/get-quote" className="inline-flex items-center gap-3 bg-white text-[#0d1f3c] hover:bg-gray-100 font-black text-lg px-10 py-5 rounded-xl transition-all shadow-xl">
