          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#e63329] rounded-2xl p-6 text-white">
                ...
                <Link href="/get-quote" className="inline-flex items-center gap-1.5 bg-white text-[#e63329] hover:bg-gray-100 px-4 py-2 rounded-lg font-bold text-sm mt-4 transition-colors">
      ...
      <section className="py-12 md:py-20 bg-gradient-to-r from-[#1a2f5a] to-[#0d1f3c] relative overflow-hidden text-center">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/get-quote" className="inline-flex items-center justify-center gap-2 bg-[#e63329] hover:bg-[#c42a21] text-white px-8 py-4 rounded-lg font-bold transition-all shadow-lg hover:shadow-xl">
              Get a Free Quote <ArrowRight className="w-4 h-4" />
            </Link>
