        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            {SHOWCASE_PRODUCTS.map(p => (
              <Link key={p.slug} href={`/products/${p.slug}`} className="group relative rounded-2xl overflow-hidden bg-gray-100 aspect-square shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <img
                  src={p.img}
                  alt={p.name}
      ...
      <section className="py-12 md:py-20 bg-[#1a2f5a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mt-12">
            <Link href="/get-quote" className="inline-flex items-center gap-2 bg-[#e63329] hover:bg-[#c42a21] text-white px-8 py-4 rounded-lg font-bold text-sm transition-all shadow-lg">
      ...
      <section className="py-20 bg-[#e63329] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/get-quote" className="inline-flex items-center justify-center gap-2 bg-white text-[#e63329] hover:bg-gray-50 px-8 py-4 rounded-lg font-bold text-sm transition-all shadow-xl hover:shadow-2xl">
              Get a Free Quote <ArrowRight className="w-4 h-4" />
            </Link>
