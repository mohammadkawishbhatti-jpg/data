  ...
  return (
    <>
      ...
      <div className="bg-[#1a2f5a] pt-14 pb-28 text-center text-white relative overflow-hidden">
        <img src="/api/uploads/printed-cardboard-gift-boxes-bulk.webp" alt="" aria-hidden="true" width={1600} height={900} className="absolute inset-0 w-full h-full object-cover" style={{opacity:0.14}} loading="eager" fetchPriority="high" decoding="async" onError={e=>{(e.target as HTMLImageElement).style.display="none";}} />
