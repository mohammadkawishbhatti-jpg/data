  ...
  return (
    <div className="group flex flex-col bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 shadow-sm">
      ...
      <div className="p-4 flex flex-col flex-1">
        <Link href={`/${product.slug}`} className="font-extrabold text-[#1a2f5a] mb-2 group-hover:text-[#e63329] transition-colors line-clamp-2 text-[0.9375rem] leading-snug tracking-tight">
          {product.name}
        </Link>
        <p className="text-gray-500 text-[0.8125rem] line-clamp-3 mb-4 flex-1 leading-relaxed font-normal">
          {excerpt}
        </p>
        <Link
