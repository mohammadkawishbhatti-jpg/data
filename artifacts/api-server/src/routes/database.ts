...
// ── GET /admin/db/stats ──────────────────────────────────────────────────────
router.get("/admin/db/stats", requireAdministrator, async (req, res) => {
  try {
...
router.get("/admin/db/export", requireAdministrator, async (req, res) => {
...
router.post("/admin/db/import", requireAdministrator, upload.single("sqlFile"), async (req: any, res) => {
...
router.post("/admin/db/truncate-table", requireAdministrator, async (req, res) => {
