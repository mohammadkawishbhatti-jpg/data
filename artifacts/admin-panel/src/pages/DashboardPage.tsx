...
import {
  ...
  Sparkles, Layers, ShieldCheck, FileOutput, Receipt, ChevronRight
} from "lucide-react";
...
export default function DashboardPage() {
  ...
  const s = stats || {
    products: 0, categories: 0, quotes: 0, leads: 0,
    blogPosts: 0, banners: 0, pages: 0, users: 0,
    newQuotes: 0, newLeads: 0,
  };
