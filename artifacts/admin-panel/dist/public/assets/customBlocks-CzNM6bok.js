const e=t=>`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round">${t}</svg>`,i=[{id:"cb-hero",label:"Hero",category:"Layout",icon:e('<rect x="3" y="6" width="34" height="28" rx="3"/><line x1="3" y1="16" x2="37" y2="16"/><line x1="10" y1="24" x2="22" y2="24"/><rect x="24" y="21" width="9" height="6" rx="2" fill="currentColor" opacity=".4"/>'),content:`<section style="background:linear-gradient(135deg,#1e2040 0%,#4f46e5 100%);padding:100px 40px;text-align:center;min-height:500px;display:flex;align-items:center;justify-content:center;flex-direction:column">
...
</section>`},{id:"cb-section",label:"Section",category:"Layout",icon:e('<rect x="3" y="4" width="34" height="32" rx="3"/><line x1="3" y1="12" x2="37" y2="12"/>'),content:`<section style="padding:80px 40px;background:#fff">
...
</section>`},{id:"cb-two-col",label:"2 Col Content",category:"Layout",icon:e('<rect x="3" y="6" width="15" height="28" rx="2"/><rect x="22" y="6" width="15" height="28" rx="2"/><line x1="6" y1="14" x2="15" y2="14"/><line x1="6" y1="20" x2="13" y2="20"/><line x1="25" y1="14" x2="34" y2="14"/><line x1="25" y1="20" x2="32" y2="20"/>'),content:`<section style="padding:70px 40px;background:#fff">
...
</section>`},{id:"cb-spacer",label:"Spacer",category:"Layout",icon:e('<line x1="20" y1="4" x2="20" y2="36"/><line x1="8" y1="4" x2="32" y2="4"/><line x1="8" y1="36" x2="32" y2="36"/>'),content:'<div style="height:60px;width:100%"></div>'},{id:"cb-divider",label:"Divider",category:"Layout",icon:e('<line x1="4" y1="20" x2="36" y2="20"/><circle cx="20" cy="20" r="3" fill="currentColor"/>'),content:'<div style="padding:20px 40px"><hr style="border:none;border-top:2px solid #e5e7eb;margin:0"/></div>'},{id:"cb-container",label:"Container",category:"Layout",icon:e('<rect x="3" y="8" width="34" height="24" rx="3"/><line x1="10" y1="8" x2="10" y2="32"/><line x1="30" y1="8" x2="30" y2="32"/>'),content:'<div style="max-width:1100px;margin:0 auto;padding:40px 20px"><p style="color:#9ca3af;text-align:center;border:2px dashed #e5e7eb;padding:40px;border-radius:8px">Drag widgets into this container</p></div>'},{id:"cb-heading",label:"Heading",category:"Typography",icon:e('<text x="4" y="28" font-size="26" font-weight="900" fill="currentColor" stroke="none" style="font-family:serif">H1</text>'),content:'<h2 style="font-size:36px;font-weight:800;color:#111827;margin:0;line-height:1.2;font-family:Inter,sans-serif">Your Main Heading Goes Here</h2>'},{id:"cb-paragraph",label:"Paragraph",category:"Typography",icon:e('<line x1="5" y1="12" x2="35" y2="12"/><line x1="5" y1="18" x2="35" y2="18"/><line x1="5" y1="24" x2="27" y2="24"/><line x1="5" y1="30" x2="31" y2="30"/>'),content:'<p style="font-size:16px;color:#374151;line-height:1.8;max-width:680px;margin:0">Add your paragraph text here. This widget lets you write rich text content that engages your visitors and communicates your message clearly and effectively.</p>'},{id:"cb-button",label:"Button",category:"Typography",icon:e('<rect x="5" y="13" width="30" height="14" rx="7"/><line x1="14" y1="20" x2="26" y2="20"/>'),content:'<div style="padding:8px 0"><a href="#" style="display:inline-block;background:#4f46e5;color:#fff;padding:13px 30px;border-radius:50px;font-size:14px;font-weight:700;text-decoration:none;font-family:Inter,sans-serif">Get Started →</a></div>'},{id:"cb-badge",label:"Badge",category:"Typography",icon:e('<rect x="6" y="14" width="28" height="12" rx="6"/><line x1="12" y1="20" x2="28" y2="20"/>'),content:'<span style="display:inline-block;background:#ede9fe;color:#4f46e5;font-size:12px;font-weight:700;padding:5px 14px;border-radius:50px;text-transform:uppercase;letter-spacing:.08em">New</span>'},{id:"cb-alert",label:"Alert Box",category:"Typography",icon:e('<path d="M20 8l14 24H6L20 8z"/><line x1="20" y1="18" x2="20" y2="24"/><circle cx="20" cy="28" r="1.5" fill="currentColor" stroke="none"/>'),content:`<div style="background:#eff6ff;border:1px solid #bfdbfe;border-left:4px solid #3b82f6;padding:14px 18px;border-radius:6px;display:flex;gap:12px;align-items:flex-start">
...
</div>`},{id:"cb-feature-cards",label:"Feature Cards",category:"Content",icon:e('<rect x="3" y="8" width="10" height="24" rx="2"/><rect x="15" y="8" width="10" height="24" rx="2"/><rect x="27" y="8" width="10" height="24" rx="2"/>'),content:`<section style="padding:70px 40px;background:#f9fafb">
  <div style="max-width:1100px;margin:0 auto">
...
</div>`},{id:"cb-testimonials-row",label:"Reviews Row",category:"Content",icon:e('<rect x="3" y="10" width="15" height="20" rx="3"/><rect x="22" y="10" width="15" height="20" rx="3"/><line x1="6" y1="16" x2="15" y2="16"/><line x1="6" y1="20" x2="13" y2="20"/><line x1="25" y1="16" x2="34" y2="16"/><line x1="25" y1="20" x2="32" y2="20"/>'),content:`<section style="padding:70px 40px;background:#fff">
  <div style="max-width:1100px;margin:0 auto">
...
</section>`},{id:"cb-pricing",label:"Pricing Card",category:"Content",icon:e('<rect x="8" y="4" width="24" height="32" rx="4"/><line x1="14" y1="13" x2="26" y2="13"/><line x1="14" y1="18" x2="24" y2="18"/><line x1="14" y1="23" x2="22" y2="23"/><rect x="10" y="28" width="20" height="6" rx="3" fill="currentColor" opacity=".4"/>'),content:`<div style="background:#fff;border-radius:16px;padding:36px;max-width:320px;border:2px solid #4f46e5;box-shadow:0 20px 40px rgba(79,70,229,.1);text-align:center">
...
</div>`},{id:"cb-stats",label:"Stats Row",category:"Content",icon:e('<line x1="5" y1="30" x2="35" y2="30"/><rect x="7" y="20" width="6" height="10" rx="1" fill="currentColor" opacity=".5"/><rect x="17" y="12" width="6" height="18" rx="1" fill="currentColor" opacity=".7"/><rect x="27" y="16" width="6" height="14" rx="1" fill="currentColor" opacity=".5"/>'),content:`<section style="padding:60px 40px;background:#1e2040">
...
</section>`},{id:"cb-progress-bar",label:"Progress Bar",category:"Content",icon:e('<rect x="4" y="15" width="32" height="10" rx="5"/><rect x="4" y="15" width="22" height="10" rx="5" fill="currentColor" opacity=".4" stroke="none"/>'),content:`<div style="padding:20px 0">
...
</div>`},{id:"cb-image-box",label:"Image Box",category:"Content",icon:e('<rect x="4" y="4" width="32" height="22" rx="3"/><line x1="4" y1="28" x2="36" y2="28"/><line x1="4" y1="34" x2="28" y2="34"/>'),content:`<div style="border-radius:14px;overflow:hidden;box-shadow:0 4px 12px rgba(0,0,0,.08);background:#fff;max-width:380px">
...
</div>`},{id:"cb-team-card",label:"Team Card",category:"Content",icon:e('<circle cx="20" cy="14" r="7"/><path d="M6 36c0-8 6-12 14-12s14 4 14 12"/>'),content:`<div style="text-align:center;padding:28px;background:#fff;border-radius:14px;border:1px solid #f3f4f6;max-width:220px">
...
</div>`},{id:"cb-product-card",label:"Product Card",category:"Content",icon:e('<rect x="4" y="4" width="32" height="32" rx="4"/><line x1="4" y1="22" x2="36" y2="22"/><line x1="10" y1="28" x2="20" y2="28"/><rect x="22" y="26" width="10" height="7" rx="3" fill="currentColor" opacity=".4"/>'),content:`<div style="border-radius:14px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.08);background:#fff;max-width:300px">
...
</ul>`},{id:"cb-comparison-table",label:"Compare Table",category:"Content",icon:e('<rect x="3" y="6" width="34" height="28" rx="3"/><line x1="3" y1="14" x2="37" y2="14"/><line x1="20" y1="6" x2="20" y2="34"/><line x1="3" y1="21" x2="37" y2="21"/><line x1="3" y1="28" x2="37" y2="28"/>'),content:`<div style="overflow-x:auto;font-family:Inter,sans-serif">
...
</div>`},{id:"cb-gallery",label:"Image Gallery",category:"Content",icon:e('<rect x="3" y="3" width="15" height="15" rx="2"/><rect x="22" y="3" width="15" height="15" rx="2"/><rect x="3" y="22" width="15" height="15" rx="2"/><rect x="22" y="22" width="15" height="15" rx="2"/>'),content:`<div style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px;padding:4px">
...
</div>`},{id:"cb-tabs",label:"Tabs",category:"Content",icon:e('<rect x="3" y="14" width="34" height="22" rx="3"/><rect x="3" y="8" width="10" height="9" rx="2"/><rect x="15" y="8" width="10" height="9" rx="2" opacity=".4"/><rect x="27" y="8" width="10" height="9" rx="2" opacity=".3"/>'),content:`<div style="font-family:Inter,sans-serif">
...
</div>`},{id:"cb-steps",label:"How It Works",category:"Content",icon:e('<circle cx="10" cy="20" r="6"/><circle cx="20" cy="20" r="6" opacity=".6"/><circle cx="30" cy="20" r="6" opacity=".4"/><line x1="16" y1="20" x2="14" y2="20"/><line x1="26" y1="20" x2="24" y2="20"/>'),content:`<section style="padding:70px 40px;background:#f9fafb">
...
</section>`},{id:"cb-faq",label:"FAQ Section",category:"Content",icon:e('<circle cx="20" cy="14" r="8"/><line x1="20" y1="12" x2="20" y2="15"/><circle cx="20" cy="17.5" r="1.2" fill="currentColor" stroke="none"/><line x1="10" y1="28" x2="30" y2="28"/><line x1="10" y1="34" x2="26" y2="34"/>'),content:`<section style="padding:70px 40px;background:#fff">
...
</section>`},{id:"cb-breadcrumb",label:"Breadcrumb",category:"Content",icon:e('<line x1="4" y1="20" x2="36" y2="20"/><polyline points="16,14 22,20 16,26"/><polyline points="26,14 32,20 26,26"/>'),content:'<nav style="padding:12px 0;font-size:13px;color:#9ca3af;font-family:Inter,sans-serif"><a href="/" style="color:#4f46e5;text-decoration:none">Home</a> <span style="margin:0 8px">›</span> <a href="/products" style="color:#4f46e5;text-decoration:none">Products</a> <span style="margin:0 8px">›</span> <span style="color:#374151">Custom Mailer Boxes</span></nav>'},{id:"cb-contact-form",label:"Contact Form",category:"Forms",icon:e('<rect x="4" y="6" width="32" height="9" rx="2"/><rect x="4" y="18" width="32" height="16" rx="2"/><rect x="4" y="37" width="14" height="7" rx="3" fill="currentColor" opacity=".4"/>'),content:`<div style="background:#fff;padding:36px;border-radius:14px;border:1px solid #e5e7eb;max-width:560px;font-family:Inter,sans-serif">
...
</div>`},{id:"cb-newsletter",label:"Newsletter",category:"Forms",icon:e('<rect x="4" y="10" width="32" height="20" rx="3"/><polyline points="4,10 20,22 36,10"/><line x1="28" y1="28" x2="28" y2="32"/>'),content:`<div style="background:linear-gradient(135deg,#faf5ff 0%,#ede9fe 100%);padding:40px;border-radius:14px;text-align:center;border:1px solid #ddd6fe">
...
</div>`},{id:"cb-search",label:"Search Bar",category:"Forms",icon:e('<circle cx="17" cy="17" r="10"/><line x1="25" y1="25" x2="35" y2="35"/>'),content:`<div style="display:flex;align-items:center;border:2px solid #e5e7eb;border-radius:50px;overflow:hidden;max-width:480px;background:#fff">
...
</div>`},{id:"cb-quote-form",label:"Quote Form",category:"Forms",icon:e('<rect x="4" y="4" width="32" height="32" rx="4"/><line x1="10" y1="13" x2="30" y2="13"/><line x1="10" y1="20" x2="30" y2="20"/><line x1="10" y1="27" x2="20" y2="27"/>'),content:`<div style="background:#fff;padding:36px;border-radius:14px;border:1px solid #e5e7eb;max-width:580px;font-family:Inter,sans-serif">
...
</div>`},{id:"cb-video-section",label:"Video Section",category:"Media",icon:e('<rect x="3" y="7" width="34" height="26" rx="3"/><polygon points="16,14 30,20 16,26" fill="currentColor" opacity=".6" stroke="none"/>'),content:`<div style="background:#000;border-radius:12px;overflow:hidden;aspect-ratio:16/9;display:flex;align-items:center;justify-content:center;max-width:700px">
...
</div>`},{id:"cb-youtube",label:"YouTube",category:"Media",icon:e('<rect x="3" y="8" width="34" height="24" rx="4"/><polygon points="16,14 28,20 16,26" fill="currentColor" opacity=".7" stroke="none"/>'),content:`<div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:12px;max-width:700px">
...
</div>`},{id:"cb-icon-grid",label:"Icon Grid",category:"Media",icon:e('<circle cx="10" cy="10" r="6"/><circle cx="30" cy="10" r="6"/><circle cx="10" cy="30" r="6"/><circle cx="30" cy="30" r="6"/>'),content:`<section style="padding:60px 40px;background:#f9fafb">
...
</section>`},{id:"cb-top-bar",label:"Top Info Bar",category:"Navigation",icon:e('<rect x="3" y="14" width="34" height="12" rx="2"/><line x1="10" y1="20" x2="18" y2="20"/><line x1="22" y1="20" x2="30" y2="20"/>'),content:`<div style="background:#1e2040;color:#a5b4fc;font-size:12px;padding:8px 20px;display:flex;justify-content:center;gap:28px;flex-wrap:wrap">
...
</div>`},{id:"cb-social-links",label:"Social Links",category:"Navigation",icon:e('<circle cx="12" cy="20" r="5"/><circle cx="28" cy="12" r="5"/><circle cx="28" cy="28" r="5"/><line x1="17" y1="18" x2="23" y2="14"/><line x1="17" y1="22" x2="23" y2="26"/>'),content:`<div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;padding:8px 0">
...
</footer>`},{id:"cb-table",label:"Table",category:"Content",icon:e('<rect x="3" y="6" width="34" height="28" rx="3"/><line x1="3" y1="14" x2="37" y2="14"/><line x1="14" y1="6" x2="14" y2="34"/><line x1="26" y1="6" x2="26" y2="34"/>'),content:`<div style="overflow-x:auto;font-family:Inter,sans-serif">
  <table style="width:100%;border-collapse:collapse;font-size:14px">
...
</div>`},{id:"cb-html-code",label:"HTML Code",category:"Developer",icon:e('<polyline points="10,14 4,20 10,26"/><polyline points="30,14 36,20 30,26"/><line x1="22" y1="8" x2="18" y2="32"/>'),content:`<!-- HTML Widget: Edit this block to add custom HTML code -->
...
</div>`},{id:"cb-embed",label:"Embed / iFrame",category:"Developer",icon:e('<rect x="4" y="8" width="32" height="24" rx="3"/><line x1="4" y1="14" x2="36" y2="14"/><circle cx="8" cy="11" r="1.5" fill="currentColor" stroke="none"/><circle cx="13" cy="11" r="1.5" fill="currentColor" stroke="none"/>'),content:`<div style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden">
...
</div>`},{id:"cb-map",label:"Google Map",category:"Developer",icon:e('<path d="M20 6c-5 0-9 4-9 9 0 7 9 17 9 17s9-10 9-17c0-5-4-9-9-9z"/><circle cx="20" cy="15" r="3.5"/>'),content:`<div style="border-radius:12px;overflow:hidden">
...
</div>`},{id:"cb-rating",label:"Star Rating",category:"Content",icon:e('<polygon points="20,6 24,16 36,16 26,23 30,34 20,27 10,34 14,23 4,16 16,16" fill="currentColor" opacity=".6" stroke="none"/>'),content:`<div style="text-align:center;padding:20px">
...
</div>`}],s=Object.fromEntries(i.map(t=>[t.id,t.icon])),p=Object.fromEntries(i.map(t=>[t.id,t.label]));function x(t){const o=t.BlockManager;i.forEach(({id:n,label:r,category:l,icon:a,content:d})=>{o.add(n,{label:r,category:l,media:a,content:d})})}export{s as C,p as a,x as r};
